...
function QR(props) {
    ...
    return (
        <div className={props.active?'fixed flex flex-col gap-8  items-center justify-center top-0 w-full h-full z-50 backdrop-blur-lg':'hidden'} onClick={()=>props.setActive(false)}>
