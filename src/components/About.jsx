...
function About() {
  return (
    <div id="about" className=" py-16 justify-start items-center gap-14 flex flex-col lg:flex-row w-full h-fit flex-wrap border-b relative">
      <div className=" flex w-full about-left">
        <div className="flex flex-col gap-5">
          ...
          <p className="md:text-xl text-lg font-light leading-[150%] w-fit text-justify">
      ...
      <div className="flex w-full about-right lg:px-6">
        <iframe
          width="460"
          height="315"
          ...
          allowFullScreen
          className="z-10 w-full lg:w-[460px]"
        />
        <div className="w-64 h-[22rem] border border-neutral-300 absolute right-0 top-12 z-0 hidden lg:block" />
      </div>
    </div>
  );
}
